...
def get_result(train_source, embed_mat, source_letter_to_int, path="SoccerData/model_1", filename=None):
    # Batch Size
    ...
    with tf.compat.v1.Session() as sess:
        ...
        graphtf = tf.compat.v1.get_default_graph()
...
if __name__ == '__main__':
    ...
    represent = get_result(source_int, embed_mat, source_letter_to_int)[0]
